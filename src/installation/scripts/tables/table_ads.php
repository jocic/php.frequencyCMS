...
$tblAds = new EasyTable();

// "Table Ads" Variable Settings.
...
(
    new EasyColumn
    (
        ColumnName::useName("section"),
        ColumnType::useEnum("0, 1, 2, 3, 4"),
        ColumnNull::notAllowed()
    )
);

$tblAds->addPrimaryKey(new EasyPrimaryKey("id"));

// Create The Table.

EasyCreate::setMode(EasyCreate::ECM_DROP_IF_EXISTS);
EasyCreate::execute($tblAds);
