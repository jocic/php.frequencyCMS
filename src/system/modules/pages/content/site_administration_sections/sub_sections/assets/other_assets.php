...
$varCoreLink = CMS_ROOT .
               ...
               "=" .
               Locales::getLink("other-assets");

$varAssetLink         = CMS_ROOT . "assets/other/";
$varErrorInfo         = null;

$varAssetNumber       = Assets::countAssets(Assets::TP_OTHER_ASSETS);
$varAssets            = Assets::fetchAssets(Assets::TP_OTHER_ASSETS);

// Create "Prefix And Sufix Stuff For Links" Variables.

$varEditAssetPrefix   = "<a id=\"edit-icon\" class=\"options-icon\" title=\"" . Locales::getCore("edit-asset") . "\" href=\"" . $varCoreLink . "&" . Locales::getVariable("option") . "=" . Locales::getLink("other-assets") . "&" . Locales::getVariable("suboption") . "=" . Locales::getLink("edit-asset") . "&" . Locales::getVariable("id") . "=";
$varDeleteAssetPrefix = "<a id=\"delete-icon\" class=\"options-icon\" title=\"" . Locales::getCore("delete-asset") . "\" href=\"" . $varCoreLink . "&" . Locales::getVariable("option") . "=" . Locales::getLink("other-assets") . "&" . Locales::getVariable("suboption") . "=" . Locales::getLink("delete-asset") . "&" . Locales::getVariable("id") . "=";
...
if ($varAssetNumber == 0)
    $parInfo->setContent(Locales::getParagraph("no-other-assets"));
else
    $parInfo->setContent(Locales::getParagraph("add-other-asset"));
...
$tblAssets->setID("other-assets-table");
...
$rowExtensions->addCell(new FTableCell(null, null, "<strong>" . Locales::getCore("allowed-extensions") . ":</strong> " . Locales::getParagraph("any-extension-except"), 2));
