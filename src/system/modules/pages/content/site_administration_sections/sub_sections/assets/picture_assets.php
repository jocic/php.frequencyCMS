...
$varCoreLink = CMS_ROOT .
               ...
               "=" .
               Locales::getLink("picture-assets");

$varAssetLink         = CMS_ROOT . "assets/images/";
$varErrorInfo         = null;

$varAssetNumber       = Assets::countAssets(Assets::TP_PICTURE_ASSETS);
$varAssets            = Assets::fetchAssets(Assets::TP_PICTURE_ASSETS);

// Create "Prefix And Sufix Stuff For Links" Variables.

$varEditAssetPrefix   = "<a id=\"edit-icon\" class=\"options-icon\" title=\"" . Locales::getCore("edit-asset") . "\" href=\"" . $varCoreLink . "&" . Locales::getVariable("option") . "=" . Locales::getLink("picture-assets") . "&" . Locales::getVariable("suboption") . "=" . Locales::getLink("edit-asset") . "&" . Locales::getVariable("id") . "=";
$varDeleteAssetPrefix = "<a id=\"delete-icon\" class=\"options-icon\" title=\"" . Locales::getCore("delete-asset") . "\" href=\"" . $varCoreLink . "&" . Locales::getVariable("option") . "=" . Locales::getLink("picture-assets") . "&" . Locales::getVariable("suboption") . "=" . Locales::getLink("delete-asset") . "&" . Locales::getVariable("id") . "=";
...
if ($varAssetNumber == 0)
    $parInfo->setContent(Locales::getParagraph("no-picture-assets"));
else
    $parInfo->setContent(Locales::getParagraph("add-picture-asset"));
...
$tblAssets->setID("picture-assets-table");
...
if ($varAssets != null)
{
    foreach ($varAssets as $asset)
    {
        ...
        $tmpRowSeparator->addCell(new FTableCell(null, null, new FDiv(null, "asset-separator"), 3));
...
$rowExtensions->addCell(new FTableCell(null, null, "<strong>" . Locales::getCore("allowed-extensions") . ":</strong> .jpg, .jpeg, .png, .gif", 2));
