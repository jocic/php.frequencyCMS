...
$varCoreLink = CMS_ROOT .
               ...
               "=" .
               Locales::getLink("video-assets");

$varAssetLink         = CMS_ROOT . "assets/videos/";
$varErrorInfo         = null;

$varAssetNumber       = Assets::countAssets(Assets::TP_VIDEO_ASSETS);
$varAssets            = Assets::fetchAssets(Assets::TP_VIDEO_ASSETS);

// Create "Prefix And Sufix Stuff For Links" Variables.

$varEditAssetPrefix   = "<a id=\"edit-icon\" class=\"options-icon\" title=\"" . Locales::getCore("edit-asset") . "\" href=\"" . $varCoreLink . "&" . Locales::getVariable("option") . "=" . Locales::getLink("video-assets") . "&" . Locales::getVariable("suboption") . "=" . Locales::getLink("edit-asset") . "&" . Locales::getVariable("id") . "=";
$varDeleteAssetPrefix = "<a id=\"delete-icon\" class=\"options-icon\" title=\"" . Locales::getCore("delete-asset") . "\" href=\"" . $varCoreLink . "&" . Locales::getVariable("option") . "=" . Locales::getLink("video-assets") . "&" . Locales::getVariable("suboption") . "=" . Locales::getLink("delete-asset") . "&" . Locales::getVariable("id") . "=";
...
if ($varAssetNumber == 0)
    $parInfo->setContent(Locales::getParagraph("no-video-assets"));
else
    $parInfo->setContent(Locales::getParagraph("add-video-asset"));
...
$tblAssets->setID("video-assets-table");
...
if ($varAssets != null)
{
    foreach ($varAssets as $asset)
    {
        ...
        $tmpRowThree->addCell(new FTableCell(null, null, "<input type='text' value='<object data=\"" . $varAssetLink . $asset["filename"] . "\" height=\"340\" width=\"640\" border=\"1\"></object>' />"));
...
$rowExtensions->addCell(new FTableCell(null, null, "<strong>" . Locales::getCore("allowed-extensions") . ":</strong> .avi, .wmv, .mp4, .flv, .ogv", 2));
