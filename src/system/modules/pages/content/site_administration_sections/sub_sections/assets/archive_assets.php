...
$varCoreLink = CMS_ROOT .
               ...
               "=" .
               Locales::getLink("archive-assets");

$varAssetLink         = CMS_ROOT . "assets/archives/";
$varErrorInfo         = null;

$varAssetNumber       = Assets::countAssets(Assets::TP_ARCHIVE_ASSETS);
$varAssets            = Assets::fetchAssets(Assets::TP_ARCHIVE_ASSETS);

// Create "Prefix And Sufix Stuff For Links" Variables.

$varEditAssetPrefix   = "<a id=\"edit-icon\" class=\"options-icon\" title=\"" . Locales::getCore("edit-asset") . "\" href=\"" . $varCoreLink . "&" . Locales::getVariable("option") . "=" . Locales::getLink("archive-assets") . "&" . Locales::getVariable("suboption") . "=" . Locales::getLink("edit-asset") . "&" . Locales::getVariable("id") . "=";
$varDeleteAssetPrefix = "<a id=\"delete-icon\" class=\"options-icon\" title=\"" . Locales::getCore("delete-asset") . "\" href=\"" . $varCoreLink . "&" . Locales::getVariable("option") . "=" . Locales::getLink("archive-assets") . "&" . Locales::getVariable("suboption") . "=" . Locales::getLink("delete-asset") . "&" . Locales::getVariable("id") . "=";
...
if ($varAssetNumber == 0)
    $parInfo->setContent(Locales::getParagraph("no-archive-assets"));
else
    $parInfo->setContent(Locales::getParagraph("add-archive-asset"));
...
$tblAssets->setID("archive-assets-table");
...
$rowExtensions->addCell(new FTableCell(null, null, "<strong>" . Locales::getCore("allowed-extensions") . ":</strong> .zip, .rar, .7z", 2));
