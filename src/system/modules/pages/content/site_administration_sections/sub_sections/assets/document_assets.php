...
$varCoreLink = CMS_ROOT .
               ...
               "=" .
               Locales::getLink("document-assets");

$varAssetLink         = CMS_ROOT . "assets/documents/";
$varErrorInfo         = null;

$varAssetNumber       = Assets::countAssets(Assets::TP_DOCUMENT_ASSETS);
$varAssets            = Assets::fetchAssets(Assets::TP_DOCUMENT_ASSETS);

// Create "Prefix And Sufix Stuff For Links" Variables.

$varEditAssetPrefix   = "<a id=\"edit-icon\" class=\"options-icon\" title=\"" . Locales::getCore("edit-asset") . "\" href=\"" . $varCoreLink . "&" . Locales::getVariable("option") . "=" . Locales::getLink("document-assets") . "&" . Locales::getVariable("suboption") . "=" . Locales::getLink("edit-asset") . "&" . Locales::getVariable("id") . "=";
$varDeleteAssetPrefix = "<a id=\"delete-icon\" class=\"options-icon\" title=\"" . Locales::getCore("delete-asset") . "\" href=\"" . $varCoreLink . "&" . Locales::getVariable("option") . "=" . Locales::getLink("document-assets") . "&" . Locales::getVariable("suboption") . "=" . Locales::getLink("delete-asset") . "&" . Locales::getVariable("id") . "=";
...
if ($varAssetNumber == 0)
    $parInfo->setContent(Locales::getParagraph("no-document-assets"));
else
    $parInfo->setContent(Locales::getParagraph("add-document-asset"));
...
$tblAssets->setID("document-assets-table");
...
$rowExtensions->addCell(new FTableCell(null, null, "<strong>" . Locales::getCore("allowed-extensions") . ":</strong> .pdf, .txt, .doc, .docx", 2));
