...
$hdSecurity = new FHeader();
$parInfo    = new FParagraph();

// "Header Security" Element Settings.

$hdSecurity->setLevel(2);
$hdSecurity->setContent(Locales::getTitle("security-logs"));
...
$divWorkplace->addElement($hdSecurity);
